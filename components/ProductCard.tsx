      ...
      <div className="relative z-10 h-full w-full p-10 flex flex-col justify-end">
        ...
        <div className="max-h-0 group-hover:max-h-[300px] opacity-0 group-hover:opacity-100 transition-all duration-700 ease-in-out overflow-hidden">
          <div className="pt-4 border-t border-white/10">
            ...
            <Link
              href="/contact"
              className="group/btn relative flex items-center justify-center w-full px-8 py-4 bg-white/5 border border-white/10 rounded-2xl font-bold text-primary-white transition-all duration-500 hover:border-transparent overflow-hidden shadow-xl"
            >
